...
#define USB_ERROR_RESET_ENUMERATION                     0xE4
...
public:
        ...
        virtual uint8_t Init(uint8_t parent __attribute__((unused)), uint8_t port __attribute__((unused)), bool lowspeed __attribute__((unused)), USB_DEVICE_DESCRIPTOR* udd __attribute__((unused))) {
                return 0;
        }
...
private:
        ...
        uint8_t AttemptConfig(uint8_t driver, uint8_t parent, uint8_t port, bool lowspeed, USB_DEVICE_DESCRIPTOR* udd);
};
